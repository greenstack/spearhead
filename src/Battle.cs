...
public class Battle<TContext>
{
    ...
    private readonly PhaseManager<TContext> _phaseManager;
    ...
    public Battle(TContext context, IActionManager actionManager, PhaseManager<TContext> phaseManager)
    {
        _context = context;
    ...
    public Battle(TContext context, PhaseManager<TContext> phaseManager) : this(context, new ActionManager(), phaseManager) {}
